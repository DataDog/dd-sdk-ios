...
internal struct LogMessageReceiver: FeatureMessageReceiver {
    ...
    func receive(message: FeatureMessage, from core: DatadogCoreProtocol) -> Bool {
        ...
        core.scope(for: DatadogLogsFeatureName)?.eventWriteContext(bypassConsent: false) { context, writer in
...
internal struct CrashLogReceiver: FeatureMessageReceiver {
    ...
    func receive(message: FeatureMessage, from core: DatadogCoreProtocol) -> Bool {
        ...
        core.v1.scope(for: DatadogLogsFeatureName)?.eventWriteContext(bypassConsent: true, forceNewBatch: false) { _, writer in
...
internal struct WebViewLogReceiver: FeatureMessageReceiver {
    ...
    func receive(message: FeatureMessage, from core: DatadogCoreProtocol) -> Bool {
        ...
        core.scope(for: DatadogLogsFeatureName)?.eventWriteContext { context, writer in
