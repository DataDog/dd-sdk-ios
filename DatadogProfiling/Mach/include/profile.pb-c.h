...
typedef struct Perftools__Profiles__Profile Perftools__Profiles__Profile;
typedef struct Perftools__Profiles__ValueType Perftools__Profiles__ValueType;
typedef struct Perftools__Profiles__Sample Perftools__Profiles__Sample;
typedef struct Perftools__Profiles__Label Perftools__Profiles__Label;
typedef struct Perftools__Profiles__Mapping Perftools__Profiles__Mapping;
typedef struct Perftools__Profiles__Location Perftools__Profiles__Location;
typedef struct Perftools__Profiles__Line Perftools__Profiles__Line;
typedef struct Perftools__Profiles__Function Perftools__Profiles__Function;
 ...
 *   mappings. For every location.mapping_id, there must be a unique
 *   Mapping with that id.
 */
struct  Perftools__Profiles__Profile
{
 ...
 */
struct  Perftools__Profiles__ValueType
{
  ProtobufCMessage base;
  /*
   * Index into string table.
 ...
 */
struct  Perftools__Profiles__Sample
{
  ProtobufCMessage base;
  /*
   * The ids recorded here correspond to a Profile.location_id.
   ...
   * result has a list of values that is the memberwise sum of the
 ...
 */
struct  Perftools__Profiles__Label
{
  ProtobufCMessage base;
  /*
   * Index into string table
 ...
 */
struct  Perftools__Profiles__Mapping
{
  ProtobufCMessage base;
  /*
   ...
   * disk for the main binary and shared libraries, or can be a virtual
   * name for dynamically created code.
   */
  /*
   * Index into string table
   */
 ...
 * Describes function and line table debug information.
 */
struct  Perftools__Profiles__Location
{
  ProtobufCMessage base;
  /*
 ...
 */
struct  Perftools__Profiles__Line
{
  ProtobufCMessage base;
  /*
 ...
 */
struct  Perftools__Profiles__Function
{
  ProtobufCMessage base;
  /*
