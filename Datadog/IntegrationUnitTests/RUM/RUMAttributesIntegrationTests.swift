...
final class RUMAttributesIntegrationTests: XCTestCase {
    ...
    func testGlobalAttributes_areAddedToActionEvents() throws {
        ...
        // When
        monitor.addAttribute(forKey: "key1", value: "value1")
        ...
        monitor.stopAction(type: .swipe, name: "swipe up")
        ...
        XCTAssertEqual(firstActionEvent.attribute(forKey: "key1"), "value1")

        let lastActionEvent = applicationView.actionEvents[2]
        XCTAssertEqual(lastActionEvent.numberOfAttributes, 2)
        XCTAssertEqual(lastActionEvent.attribute(forKey: "key1"), "value1")
    ...
    func testGlobalAttributes_areAddedToResourceEvents() throws {
        ...
        XCTAssertEqual(firstResourceEvent.numberOfAttributes, 2)
        ...
        XCTAssertEqual(lastResourceEvent.attribute(forKey: "key1"), "value1")
    ...
    func testGlobalAttributes_areAddedToErrorEvents() throws {
        ...
        monitor.addAttribute(forKey: "key3", value: "value3")
        monitor.addError(message: .mockAny(), type: nil, stack: nil, source: .custom, attributes: ["key4": "value4"], file: nil, line: nil)
        ...
        XCTAssertEqual(firstErrorEvent.attribute(forKey: "key1"), "value1")
        ...
        XCTAssertEqual(lastResourceEvent.attribute(forKey: "key1"), "value1")
        XCTAssertEqual(lastResourceEvent.attribute(forKey: "key3"), "value3")
        XCTAssertEqual(lastResourceEvent.attribute(forKey: "key4"), "value4")
    }
}
