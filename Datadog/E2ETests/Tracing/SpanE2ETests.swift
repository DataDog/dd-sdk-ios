...
class SpanE2ETests: E2ETests {
    ...
    func test_trace_span_set_operation_name() {
        let span = DatadogTracer.shared().startSpan(operationName: .mockRandom())
    ...
    func test_trace_span_set_tag() {
        let span = DatadogTracer.shared().startSpan(operationName: "ios_trace_span_set_tag")
    ...
    func test_trace_span_set_active() {
        let span = DatadogTracer.shared().startSpan(operationName: "trace_span_set_active_measured_span")
    ...
    func test_trace_span_log() {
        let span = DatadogTracer.shared().startSpan(operationName: "trace_span_log_measured_span")
    ...
    func test_trace_span_finish() {
        let span = DatadogTracer.shared().startSpan(operationName: "trace_span_finish_measured_span")
