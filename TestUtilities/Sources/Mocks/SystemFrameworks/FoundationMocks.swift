...
public class BundleMock: Bundle, @unchecked Sendable {
...
public class ProcessInfoMock: ProcessInfo, @unchecked Sendable {
...
private class URLSessionDataTaskMock: URLSessionDataTask, @unchecked Sendable {
