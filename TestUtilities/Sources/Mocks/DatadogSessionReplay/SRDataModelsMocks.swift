...
extension SRTextWireframe: AnyMockable, RandomMockable {
    ...
    @_spi(Internal)
    public static func mockRandomWith(id: WireframeID) -> SRTextWireframe {
...
extension SRShapeWireframe: AnyMockable, RandomMockable {
    ...
    @_spi(Internal)
    public static func mockRandomWith(id: WireframeID) -> SRShapeWireframe {
...
extension SRPlaceholderWireframe: AnyMockable, RandomMockable {
    ...
    @_spi(Internal)
    public static func mockRandomWith(id: WireframeID) -> SRPlaceholderWireframe {
        return SRPlaceholderWireframe(
            clip: .mockRandom(),
            height: .mockRandom(),
            id: id,
...
extension SRImageWireframe: AnyMockable, RandomMockable {
    ...
    public static func mockRandomWith(id: WireframeID) -> SRImageWireframe {
        return SRImageWireframe(
            base64: .mockRandom(),
            border: .mockRandom(),
            clip: .mockRandom(),
...
extension SRWireframe: AnyMockable, RandomMockable {
    ...
    public static func mockRandomWith(id: WireframeID) -> SRWireframe {
        return [
...
extension SRRecord {
    public var isFullSnapshotRecord: Bool {
        switch self {
    ...
    public var isIncrementalSnapshotRecord: Bool {
        switch self {
    ...
    public var isViewEndRecord: Bool {
        switch self {
    ...
    public var isVisualViewportRecord: Bool {
        switch self {
    ...
    public var incrementalSnapshot: SRIncrementalSnapshotRecord? {
        switch self {
    ...
    public var fullSnapshot: SRFullSnapshotRecord? {
        switch self {
...
extension SRIncrementalSnapshotRecord {
    public var pointerInteractionData: SRIncrementalSnapshotRecord.Data.PointerInteractionData? {
        switch data {
    ...
    public var viewportResizeData: SRIncrementalSnapshotRecord.Data.ViewportResizeData? {
        switch data {
...
extension SRWireframe {
    public var textWireframe: SRTextWireframe? {
    ...
    public var shapeWireframe: SRShapeWireframe? {
    ...
    public var imageWireframe: SRImageWireframe? {
    ...
    public var placeholderWireframe: SRPlaceholderWireframe? {
