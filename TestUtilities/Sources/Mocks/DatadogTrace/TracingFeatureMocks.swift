...
extension SpanEvent: AnyMockable, RandomMockable {
    public static func mockWith(
        ...
        clientSideStatsComputationEnabled: Bool = false,
        origin: String? = nil,
        ...
        return SpanEvent(
            ...
            isError: isError,
            source: source,
            clientSideStatsComputationEnabled: clientSideStatsComputationEnabled,
            origin: origin,
    ...
    public static func mockRandom() -> SpanEvent {
        return SpanEvent(
            ...
            isError: .random(),
            source: .mockRandom(),
            clientSideStatsComputationEnabled: .random(),
            origin: .mockRandom(),
