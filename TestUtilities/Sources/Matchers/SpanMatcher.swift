...
public class SpanMatcher {
    ...
    public struct Meta {
        ...
        public func accountID()            throws -> String { try matcher.meta(forKeyPath: "meta.account.id") }
        public func accountName()          throws -> String { try matcher.meta(forKeyPath: "meta.account.name") }
