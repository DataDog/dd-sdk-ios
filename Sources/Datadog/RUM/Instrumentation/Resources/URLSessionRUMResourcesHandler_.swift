...
internal final class URLSessionRUMResourcesHandler_: DatadogURLSessionHandler, RUMCommandPublisher {
    /// The date provider
...
//        self.dateProvider = dateProvider
//        self.rumAttributesProvider = rumAttributesProvider
//        self.distributedTracing = distributedTracingConfiguration.map {
//            .init(
//                sampler: .init(samplingRate: $0.tracingSamplingRate),
//                firstPartyHosts: .init($0.firstPartyHosts)
//            )
//        }
//    }
    ...
    func modify(request: URLRequest, headerTypes: Set<DatadogInternal.TracingHeaderType>) -> URLRequest {
        ...
        headerTypes.forEach {
            ...
            case .datadog:
                ...
                request.setValue("rum", forHTTPHeaderField: "x-datadog-origin")
            case .b3:
