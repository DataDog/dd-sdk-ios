...
private extension FeaturesConfiguration {
    func asTelemetry() -> TelemetryConfigurationEvent.Telemetry.Configuration {
        ...
        return TelemetryConfigurationEvent.Telemetry.Configuration(
            ...
            trackBackgroundEvents: self.rum?.backgroundEventTrackingEnabled ?? false,
            trackCrossPlatformLongTasks: false,
            trackErrors: self.crashReporting != nil,
            trackFlutterPerformance: false,
            trackFrustrations: self.rum?.frustrationTrackingEnabled ?? false,
            ...
            useAllowedTracingOrigins: false,
            useAttachToExisting: false,
            useBeforeSend: false,
