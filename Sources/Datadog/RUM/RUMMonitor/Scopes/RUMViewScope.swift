    ...
    private func sendViewUpdateEvent(on command: RUMCommand, context: DatadogV1Context, writer: Writer) {
        ...
        let viewEvent = RUMViewEvent(
            ...
            view: .init(
                ...
                firstInputDelay: nil,
                firstInputTime: nil,
                flutterBuildTime: viewPerformanceMetrics[PerformanceMetric.flutterBuildTime]?.asFlutterBuildTime(),
                flutterRasterTime: viewPerformanceMetrics[PerformanceMetric.flutterRasterTime]?.asFlutterRasterTime(),
                ...
                jsRefreshRate: viewPerformanceMetrics[PerformanceMetric.jsRefreshRate]?.asJsRefreshRate(),
