...
public extension FixedWidthInteger {
    var seconds: TimeInterval { return TimeInterval(self) }
    var minutes: TimeInterval { return TimeInterval(self.multipliedReportingOverflow(by: 60).partialValue) }
    var hours: TimeInterval { return TimeInterval(self.multipliedReportingOverflow(by: Self(60.minutes)).partialValue) }
    var days: TimeInterval { return TimeInterval(self.multipliedReportingOverflow(by: Self(24.hours)).partialValue) }
}

// MARK: - Bytes Size Convenience
