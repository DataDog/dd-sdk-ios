...
///   - capacity: Capacity of the allocated memory to contain the decoded data. 1MB by default.
/// - Returns: Decompressed data.
func inflate(_ data: Data, capacity: Int = 1_000_000) -> Data? {
