...
class DateCorrectorTests: XCTestCase {
    ...
    func testWhenServerTimeIsNotAvailable_itDoesNoCorrection() {
        ...
        XCTAssertEqual(corrector.currentCorrection.adjustToServerDate(randomDeviceTime), randomDeviceTime)
    }
    ...
    func testWhenServerTimeIsAvailable_itCorrectsDatesByTimeDifference() {
        ...
        XCTAssertTrue(
            datesEqual(
                corrector.currentCorrection.adjustToServerDate(deviceDateProvider.currentDate()),
        ...
        XCTAssertTrue(
            datesEqual(
                corrector.currentCorrection.adjustToServerDate(randomDeviceTime),
    ...
    func testRandomlyCallingCorrectionConcurrentlyDoesNotCrash() {
        ...
        DispatchQueue.concurrentPerform(iterations: 50) { iteration in
            _ = corrector.currentCorrection.adjustToServerDate(.mockRandomInThePast())
        }
    }
}
