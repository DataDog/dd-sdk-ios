...
class WKWebViewRecorderTests: XCTestCase {
    ...
    func testVisibleWebViewSlot() throws {
        ...
        XCTAssertEqual(wireframe.x, Int64(dd_withNoOverflow: attributes.frame.minX))
        XCTAssertEqual(wireframe.y, Int64(dd_withNoOverflow: attributes.frame.minY))
        XCTAssertEqual(wireframe.width, Int64(dd_withNoOverflow: attributes.frame.width))
        XCTAssertEqual(wireframe.height, Int64(dd_withNoOverflow: attributes.frame.height))
