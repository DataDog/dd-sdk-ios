...
internal func swizzle(originalClass: AnyClass,
    ...
    let didAddMethod = class_addMethod(
        isOriginalSelectorClassMethod ? object_getClass(originalClass) : originalClass,
        originalSelector,
    ...
    if didAddMethod {
        class_replaceMethod(
            isSwizzledSelectorClassMethod ? object_getClass(swizzledClass) : swizzledClass,
            swizzledSelector,
...
extension UIImage {
    ...
    fileprivate class func image(
        named name: String,
        in bundle: Bundle,
        with config: UIImage.Configuration
    ) -> UIImage? {
