...
@available(iOS 13.0, *)
extension DisplayList: Reflection_ {
...
@available(iOS 13.0, *)
extension DisplayList.Identity: Reflection_ {
    init(_ mirror: ReflectionMirror) throws {
...
@available(iOS 13.0, *)
extension DisplayList.Seed: Reflection_ {
    init(_ mirror: ReflectionMirror) throws {
        value = try mirror.descendant("value")
    }
}
...
@available(iOS 13.0, *)
extension DisplayList.ViewRenderer: Reflection_ {
    init(_ mirror: ReflectionMirror) throws {
...
@available(iOS 13.0, *)
extension DisplayList.ViewUpdater: Reflection_ {
    init(_ mirror: ReflectionMirror) throws {
...
@available(iOS 13.0, *)
extension DisplayList.Effect: Reflection_ {
    init(_ mirror: ReflectionMirror) throws {
...
@available(iOS 13.0, *)
extension DisplayList.ViewUpdater.ViewCache: Reflection_ {
    init(_ mirror: ReflectionMirror) throws {
...
@available(iOS 13.0, *)
extension DisplayList.ViewUpdater.ViewCache.Key: Reflection_ {
    init(_ mirror: ReflectionMirror) throws {
...
@available(iOS 13.0, *)
extension DisplayList.Index.ID: Reflection_ {
    init(_ mirror: ReflectionMirror) throws {
...
@available(iOS 13.0, *)
extension DisplayList.ViewUpdater.ViewInfo: Reflection_ {
    init(_ mirror: ReflectionMirror) throws {
...
@available(iOS 13.0, *)
extension DisplayList.Content: Reflection_ {
    init(_ mirror: ReflectionMirror) throws {
...
@available(iOS 13.0, *)
extension DisplayList.Content.Value: Reflection_ {
    init(_ mirror: ReflectionMirror) throws {
        switch (mirror.displayStyle, mirror.descendant(0)) {

        case let (.enum("shape"), tuple as (SwiftUI.Path, Any, SwiftUI.FillStyle)):
            let paint = try ResolvedPaint(reflecting_: tuple.1)
            self = .shape(tuple.0, paint, tuple.2)

        case let (.enum("text"), tuple as (Any, CGSize)):
            let view = try StyledTextContentView(reflecting_: tuple.0)
            self = .text(view, tuple.1)
        ...
        case let (.enum("color"), color as Any):
            let color = try Color._Resolved(reflecting_: color)
            self = .color(color)
...
@available(iOS 13.0, *)
extension DisplayList.Item: Reflection_ {
    init(_ mirror: ReflectionMirror) throws {
        identity = try mirror.descendant("identity")
...
@available(iOS 13.0, *)
extension DisplayList.Item.Value: Reflection_ {
    init(_ mirror: ReflectionMirror) throws {
        switch (mirror.displayStyle, mirror.descendant(0)) {

        case let (.enum("effect"), tuple as (Any, Any)):
            let effect = try DisplayList.Effect(reflecting_: tuple.0)
            let list = try DisplayList(reflecting_: tuple.1)
            self = .effect(effect, list)

        case let (.enum("content"), value as Any):
            let content = try DisplayList.Content(reflecting_: value)
            self = .content(content)
