...
class W3CHTTPHeadersWriterTests: XCTestCase {
    func testWritingSampledTraceContext_withHeadBasedSamplingStrategy() {
        ...
        XCTAssertEqual(headers[W3CHTTPHeaders.tracestate], "dd=o:rum;p:0000000000000929;s:1;t.rsid:abcdef01-2345-6789-abcd-ef0123456789")
    }
    ...
    func testWritingDroppedTraceContext_withHeadBasedSamplingStrategy() {
        ...
        XCTAssertEqual(headers[W3CHTTPHeaders.tracestate], "dd=o:rum;p:0000000000000929;s:0;t.rsid:abcdef01-2345-6789-abcd-ef0123456789")
    }
