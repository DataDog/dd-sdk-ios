...
class FilesOrchestrator_MetricsTests: XCTestCase {
    ...
    func testWhenReadableFileIsDeleted_itSendsBatchDeletedMetric() throws {
        ...
        DDAssertJSONEqual(metric.attributes, [
            ...
            "uploader_delay": [
                "min": upload.minUploadDelay.dd_toMilliseconds,
                "max": upload.maxUploadDelay.dd_toMilliseconds
            ],
            "uploader_window": storage.uploaderWindow.dd_toMilliseconds,
            "in_background": false,
            "background_tasks_enabled": false,
            "batch_age": expectedBatchAge.dd_toMilliseconds,
    ...
    func testWhenObsoleteFileIsDeleted_itSendsBatchDeletedMetric() throws {
        ...
        DDAssertJSONEqual(metric.attributes, [
            ...
            "in_background": false,
            "background_tasks_enabled": false,
            "batch_age": (storage.maxFileAgeForRead + 1).dd_toMilliseconds,
    ...
    func testWhenNewBatchIsStarted_itSendsBatchClosedMetric() throws {
        ...
        DDAssertReflectionEqual(metric.attributes, [
            ...
            "batch_duration": expectedWriteDelays.reduce(0, +).dd_toMilliseconds
        ])
