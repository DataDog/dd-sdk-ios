...
- Accepted SDK/harness source remains signed `af63657f0` (EXP-159, 15/15 mapper
  and backend). EXP-160/161 change tooling/documentation only. Do not rerun
  EXP-158/159 or accepted baseline/acceptance runs merely to resume.
- Current finite release register: **11/66 gates closed**. Read PLAN and
...
- **Current executable task:** execute predefined EXP-162 for D01/D02, starting
  with complete-module failing controls before the platform guards are repaired. Then D09/D11/D12 early
  compatibility, D04 with P02, D05/D06 restoration, D03/P03 lifetime, D07/D08
...
- Physical queue remains at H01/EXP-129 until capable iPad/Duo hardware is live.
  Latest discovery had no available physical iPad; a paired iPhone was available.
...
5. EXP-160/161 in [EXP-143-199.md](/Users/valentin.pertuisot/work/dd-sdk-ios/DatadogRUM/MultiSceneSupport/Experiments/EXP-143-199.md); inspect EXP-159 only for a relevant regression.
...
within its documented boundary. On resume, begin the assessed D01/D02 regression-repair definition;
early baseline and acceptance tooling already exist and have measured results.
