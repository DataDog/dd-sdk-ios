...
- **Current executable task:** execute predefined EXP-164 for D09 controller
  caller-thread compatibility, then define D11 legacy native/WebView correlation. Then D04 with P02, D05/D06 restoration, D03/P03 lifetime, D07/D08
...
- Evidence checkpoints `0f91747a4` (EXP-162) and `6b7a53dd7` (EXP-163) are
  unsigned locally after signing-agent timeouts. SDK fixes remain signed. Verify/
  sign these checkpoints before any
...
execute defined EXP-164; baseline and acceptance tooling
