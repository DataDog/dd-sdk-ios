...
- **Current executable task:** audit and define the smallest T03 Resource
  explicit-start/captured-completion slice, including late failed completion
  against a new session continuous action. Do not expand T03–T14 before relevant dependencies pass. Deferred
...
5. EXP-160 through EXP-174 in [EXP-143-199.md](/Users/valentin.pertuisot/work/dd-sdk-ios/DatadogRUM/MultiSceneSupport/Experiments/EXP-143-199.md); inspect EXP-159 only for a relevant regression.
...
define the next T03 Resource ownership slice; baseline and acceptance tooling
