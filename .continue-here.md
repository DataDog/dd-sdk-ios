...
- Current SDK checkpoint is signed `7b77f60eb` (EXP-168 keyed SwiftUI lifetime repair);
...
- Current finite release register: **23/66 gates closed**. Read PLAN and
...
- **Current executable task:** define D07 pending semantic authority, then D08
  accepted reconnect publication and P03 disconnected-registry retirement.
  D10 accepted presentation state follows. P03 remains open until its registry/
  disconnect budget passes. Three review findings remain open. Do not expand T03–T14 before relevant dependencies pass. Deferred
...
5. EXP-160 through EXP-168 in [EXP-143-199.md](/Users/valentin.pertuisot/work/dd-sdk-ios/DatadogRUM/MultiSceneSupport/Experiments/EXP-143-199.md); inspect EXP-159 only for a relevant regression.
