...
- Current SDK checkpoint is signed `66d1ccb02` (EXP-170 accepted reconnect);
...
- Current finite release register: **25/66 gates closed**. Read PLAN and
...
- EXP-170 passes at signed `66d1ccb02`: three failing controls, seven focused
  ...
  R04 still needs remount without body/source rebind. Invalid package/test-build and inconclusive fixture
  attempts are preserved; no genuine OS/physical ordering is claimed.
- **Current executable task:** execute defined EXP-171 for R04 retained-reader
  remount without body/source rebind, then P03 disconnected-registry retirement and its unchanged
  Release retention budget. D10 accepted presentation state
  follows, then remaining R05/R06 discriminators. One production-review finding
  remains open. Do not expand T03–T14 before relevant dependencies pass. Deferred
...
5. EXP-160 through EXP-170 in [EXP-143-199.md](/Users/valentin.pertuisot/work/dd-sdk-ios/DatadogRUM/MultiSceneSupport/Experiments/EXP-143-199.md); inspect EXP-159 only for a relevant regression.
