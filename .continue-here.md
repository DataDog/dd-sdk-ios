...
- Current SDK checkpoint is signed `4653e0a72` (EXP-172 scene registry retirement);
...
- Current finite release register: **27/66 gates closed**. Read PLAN and
...
- **Current executable task:** execute defined EXP-173 for D10/R06 accepted
  presentation state and same-ID occurrence coverage, then R05 multi-observer fan-out.
  One production-review finding
