...
- Current SDK checkpoint is signed `4ba7179c6` (EXP-171 retained-reader remount);
...
- Current finite release register: **26/66 gates closed**. Read PLAN and
...
- **Current executable task:** execute defined EXP-172 for P03 disconnected-
  registry retirement and its unchanged Release retained-state budget. D10 accepted presentation
...
5. EXP-160 through EXP-171 in [EXP-143-199.md](/Users/valentin.pertuisot/work/dd-sdk-ios/DatadogRUM/MultiSceneSupport/Experiments/EXP-143-199.md); inspect EXP-159 only for a relevant regression.
