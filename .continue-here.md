...
- Current SDK checkpoint is local unsigned `a9aaf25a7` (EXP-169 pending authority);
  the prior lifetime repair `7b77f60eb` is signed.
...
- Current finite release register: **24/66 gates closed**. Read PLAN and
...
- **Current executable task:** execute defined EXP-170 for D08 accepted reconnect publication, then
  P03 disconnected-registry retirement. D10 accepted presentation state follows.
  P03 remains open until its registry/disconnect budget passes. Two review
  findings remain open. Do not expand T03–T14 before relevant dependencies pass. Deferred
...
5. EXP-160 through EXP-169 in [EXP-143-199.md](/Users/valentin.pertuisot/work/dd-sdk-ios/DatadogRUM/MultiSceneSupport/Experiments/EXP-143-199.md); inspect EXP-159 only for a relevant regression.
