...
- Current SDK checkpoint is signed `084dff4c1` (EXP-163 D12 stop metadata repair);
...
- Current finite release register: **15/66 gates closed**. Read PLAN and
...
- **Current executable task:** define and execute D09 controller caller-thread
  compatibility, then D11 legacy native/WebView correlation. Then D04 with P02, D05/D06 restoration, D03/P03 lifetime, D07/D08
...
define D09 next; baseline and acceptance tooling
