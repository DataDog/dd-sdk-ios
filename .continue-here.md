...
- Current SDK checkpoint is local `a9abc092b` (EXP-164 D09 caller-thread repair);
...
- Current finite release register: **16/66 gates closed**. Read PLAN and
...
- **Current executable task:** execute EXP-165, defined for D11 legacy native/WebView
  correlation with Replay association and a cross-scene negative control. Then D04 with P02, D05/D06 restoration, D03/P03 lifetime, D07/D08
...
- Physical queue remains at H01/EXP-129 until capable iPad/Duo hardware is live.
  Latest discovery had no available physical iPad or iPhone; watch availability changed between queries and must be rediscovered. iOS 27 and 26.5 simulators are available; iOS 15 is not.
...
5. EXP-160/161/162/163/164 in [EXP-143-199.md](/Users/valentin.pertuisot/work/dd-sdk-ios/DatadogRUM/MultiSceneSupport/Experiments/EXP-143-199.md); inspect EXP-159 only for a relevant regression.
...
execute the defined EXP-165 next; baseline and acceptance tooling
