...
- **Current executable task:** execute predefined EXP-163 for D12 overdue-stop
  metadata; add failing controls before production edits. D09/D11 follow in the
  independent early compatibility group. Then D04 with P02, D05/D06 restoration, D03/P03 lifetime, D07/D08
...
- EXP-162 evidence checkpoint `0f91747a4` is unsigned locally after a signing-agent
  timeout. Its SDK fixes remain signed. Verify/sign this checkpoint before any
...
5. EXP-160/161/162/163 in [EXP-143-199.md](/Users/valentin.pertuisot/work/dd-sdk-ios/DatadogRUM/MultiSceneSupport/Experiments/EXP-143-199.md); inspect EXP-159 only for a relevant regression.
...
execute the defined D12 compatibility repair; baseline and acceptance tooling
