...
- Current SDK checkpoint is signed `9a1ee83a5` (EXP-165 D11 WebView compatibility);
...
- Current finite release register: **17/66 gates closed**. Read PLAN and
...
- **Current executable task:** execute EXP-166, defined for D04 core/lifecycle
  handoff isolation with P02 allocation repair. Consumer audit includes RUM,
  Resources, Logs and Trace; same application IDs are not an ownership key.
  Then D05/D06 restoration, D03/P03 lifetime, D07/D08 authority/reconnect and D10
  accepted presentation state. Seven review findings remain open. Do not expand
  T03–T14 before relevant repairs/baselines pass. Deferred extraction remains
  after release freeze; posted notifications never close hardware gates.
...
5. EXP-160/161/162/163/164/165 in [EXP-143-199.md](/Users/valentin.pertuisot/work/dd-sdk-ios/DatadogRUM/MultiSceneSupport/Experiments/EXP-143-199.md); inspect EXP-159 only for a relevant regression.
