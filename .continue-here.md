...
- Current SDK checkpoint is signed `5eb3c1aac` (EXP-166 D04/P02 handoff repair);
...
- Current finite release register: **19/66 gates closed**. Read PLAN and
...
- **Current executable task:** define EXP-167 before implementing D05/D06:
  resolve old navigation ownership once before peer restoration, including
  source-less starts and identity stops; share explicit-stop/immediate/lazy
  timeout/max-duration restoration policy. Then D03/P03 lifetime, D07/D08
  authority/reconnect and D10 accepted presentation state. Six review findings
  remain open. Do not expand T03–T14 before relevant dependencies pass. Deferred
