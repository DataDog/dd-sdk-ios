...
3. D03 mounted lifetime passes EXP-168 and bounded R02 review is complete.
   D07 pending authority passes EXP-169. Next repair D08 reconnect and P03
   registry retirement, then D10. Keep the missing R04/R05/R06 discriminators in those slices. Each fix is a small
