...
| EXP-162 | 2026-09-17 | DEFINED · D01/D02 | Platform compatibility | Reproduce complete watchOS RUM/macOS WebView build failures, repair platform guards, then require both builds and focused iOS routing checks. | [active record](Experiments/EXP-143-199.md#exp-162--restore-watchos-resource-and-macos-webview-compilation) |
