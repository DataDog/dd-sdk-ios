...
pass 126/126 tests (`EXP-108` through `EXP-135`). The exact-scene manual-authority
...
integration after API review. The full probe plan now passes 126/126.
