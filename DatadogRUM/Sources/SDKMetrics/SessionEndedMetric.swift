    ...
    func asMetricAttributes(with context: DatadogContext) -> [String: Encodable] {
        ...
        if let firstView = firstTrackedView, let lastView = lastTrackedView {
            ...
            if sessionStart < sessionEnd { // sanity check
                ...
                lifecycleInfo = .init(
                    timeToSessionStart: firstView.startMs - context.launchInfo.processLaunchDate.timeIntervalSince1970.dd_toInt64Milliseconds,
        ...
        return [
            ...
            Constants.rseKey: Attributes(
                ...
                ntpOffset: .init(
                    atStart: ntpOffsetAtStart.dd_toInt64Milliseconds,
                    atEnd: context.serverTimeOffset.dd_toInt64Milliseconds
                ),
                ...
                launchInfo: .init(
                    ...
                    timeToSdkInit: context.sdkInitDate.timeIntervalSince(context.launchInfo.processLaunchDate).dd_toInt64Milliseconds,
                    timeToDidBecomeActive: context.launchInfo.timeToDidBecomeActive?.dd_toInt64Milliseconds,
