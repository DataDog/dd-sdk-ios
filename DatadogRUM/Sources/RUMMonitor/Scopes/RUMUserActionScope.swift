    ...
    private func sendActionEvent(completionTime: Date, on command: RUMCommand, context: DatadogContext, writer: Writer) {
        ...
        let actionEvent = RUMActionEvent(
            ...
            action: .init(
                ...
                loadingTime: completionTime.timeIntervalSince(actionStartTime).dd_toInt64Nanoseconds,
            ...
            date: actionStartTime.addingTimeInterval(serverTimeOffset).timeIntervalSince1970.dd_toInt64Milliseconds,
