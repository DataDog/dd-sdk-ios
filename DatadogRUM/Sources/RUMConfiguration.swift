...
extension RUM {
    ...
    public struct Configuration {
        ...
        /// Determines whether automatic tracking of anonymous user id is enabled.
        ///
        /// If enabled, the SDK will automatically track the anonymous user id for each RUM Session, which
