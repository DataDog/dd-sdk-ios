...
internal struct SegmentJSONBuilder {
    ...
    /// Groups given records into segments.
    /// - Parameter records: records to bundle within segments. For best performance, this array must
    /// be ordered in a way that the same RUM context appears in continuous ranges.
    /// - Returns: array of segment JSON objects
